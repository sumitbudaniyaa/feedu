/**
 * Shared Tailwind preset for all Feedo frontends.
 * Colors map to CSS variables defined in @feedo/ui/styles/globals.css,
 * enabling runtime dark/light theme switching.
 */
